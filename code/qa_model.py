...
from modules import RNNEncoder, SimpleSoftmaxLayer, BasicAttn, BidafAttn, MultiRNNEncoder, CoAttn
...
class QAModel(object):
    ...
    def add_embedding_layer(self, emb_matrix):
        ...
        with vs.variable_scope("embeddings"):
            ...
            self.context_char_embs = embedding_ops.embedding_lookup(char_emb_matrix, self.context_char_ids)
    ...
    def build_graph(self):
        ...
        context_cnn_maxpool = tf.nn.dropout(context_cnn_maxpool, self.keep_prob)
        ...
        qn_cnn_maxpool = tf.nn.dropout(qn_cnn_maxpool, self.keep_prob)
        ...
        _, attn_output = attn_layer.build_graph(question_hiddens, self.qn_mask, context_hiddens, self.context_mask) # attn_output is shape (batch_size, context_len, hidden_size*6)
