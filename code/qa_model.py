...
from modules import RNNEncoder, SimpleSoftmaxLayer, BasicAttn, MultAttn
...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        attn_layer = MultAttn(self.keep_prob, self.FLAGS.hidden_size*2, self.FLAGS.hidden_size*2)
