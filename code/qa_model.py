...
from modules import RNNEncoder, SimpleSoftmaxLayer, BasicAttn, MultAttn, BahdanauAttn, SelfAttn, BasicSelfAttn
...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        self_attn_layer = BasicSelfAttn(self.keep_prob, self.FLAGS.hidden_size*2, self.FLAGS.hidden_size*2)
